...
if address == '':
    address = 'http://localhost:5000/users'
...
try:
    ...
    print(
        "Test 1 PASS: Succesfully made a new user")
...
try:
    ...
    print(
        "Test 2 FAILED: Could not add new bagels")
    print(
        err.args)
    sys.exit()
else:
    print(
        "Test 2 PASS: Succesfully made new bagels")
...
try:
    ...
    print(
        "Test 3 PASS: App checks against invalid credentials")
...
try:
    ...
    print(
        "Test 4 PASS: Logged in User can view /bagels")
    print(
        "ALL TESTS PASSED!")
